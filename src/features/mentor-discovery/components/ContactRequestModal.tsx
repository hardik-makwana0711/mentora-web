    ...
    <Modal open={open} title={tr.contactMentorTitle} onClose={onClose} footer={footer}>
      {submitted ? (
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <fieldset>
            <legend className="mb-2 text-sm font-medium text-[var(--color-m-text)]">
              {tr.requestType}
            </legend>
          ...
          {isParent ? (
            <div>
              ...
              <p className="mb-2 text-xs text-[var(--color-m-text-muted)]">
                {tr.selectStudentHint}
              </p>
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-[var(--color-m-text)]">
              {tr.preferredTimeSlots}
            </label>

            <Input
              placeholder={tr.preferredTimeSlotsHint}
              {...form.register('preferred_time_slots')}
            />
          </div>
